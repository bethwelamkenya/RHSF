...
public val CustomIcon.SortByCreationDate: ImageVector
    get() {
        if (_sortByCreationDate != null) {
            return _sortByCreationDate!!
        }
        _sortByCreationDate = Builder(name = "SortByCreationDate", defaultWidth = 480.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF43A047)), stroke = SolidColor(Color(0x00000000)),
                    strokeLineWidth = 0.0f, strokeLineCap = Butt, strokeLineJoin = Miter,
                    strokeLineMiter = 4.0f, pathFillType = NonZero) {
                moveTo(170.0f, 110.0f)
                lineTo(310.0f, 110.0f)
                lineTo(310.0f, 150.0f)
...
private var _sortByCreationDate: ImageVector? = null
