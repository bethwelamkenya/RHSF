...
public val CustomIcon.SortByStartDate: ImageVector
    get() {
        if (_sortByStartDate != null) {
            return _sortByStartDate!!
        }
        _sortByStartDate = Builder(name = "SortByStartDate", defaultWidth = 480.0.dp, defaultHeight
...
private var _sortByStartDate: ImageVector? = null
